        ...
        <style type="text/css">
            * {
            ...
            .login:hover {
                ...
                color:#090909;
                background-color: rgb(9, 248, 89);
                transition: 0.5s;
                cursor: pointer;
            } 
            .signup {
                margin: 0px 10px;
                border: 2px solid#04d0ef;
                padding: 13px 35px;
                letter-spacing: 1px;
                color: rgb(6, 0, 0);
                border-radius: 30px;
            ...
            .signup:hover {
                border: 2px solid#04cffc;
                color:#080808;
                background-color: rgb(16, 205, 38);
                transition: 0.5s;
                cursor: pointer;
            }
            footer {
    ...
    <div class="banner">
        ...
        <div class="image">
            <table cellspacing="20"> 
                <tr align="center">
                    <td> <img src="Akash.jpg"> </td>
                    <td> <img src="vijay.webp"> </td>
                    <td> <img src="thala.jpg"> </td>
                    <td> <img src="suriya.avif"> </td>
    ...
    <div class="banner">
        ...
        <div class="box">
            ...
            <div class="box-2"> 
                ...
                <p> <span>Address</span> : 51,vadamalai street; sowcarpet chennai-600001</p>
                <p> <span>Email</span> : samakash1245@gmail.com </p>
                <p> <span>Phone</span> : 9962214892</p>
            </div>
        </div>
    </div>
    <footer>
